-- Run in Supabase SQL Editor if generate_bills_for_month still fails with previous_dues NULL (23502).
-- Replaces only generate_bills_for_month; safe to run on existing DBs.
